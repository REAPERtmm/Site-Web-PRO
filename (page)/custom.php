    ...
    <div class="custom-mid">
        ...
        <div class="other-choice">
            <div class="keycaps-line">
                ...
                <a class="help"
                    href="https://www.cybertek.fr/blog/peripheriques/clavier-pc/quel-type-de-switch-choisir-pour-son-clavier">Comment
                    choisir son switch </a>
                <div class="dropdown">
                    <button class="keycaps-choice-box dropbtn" onclick="Dropdown()">Afficher les différents
                        switch</button>
                    <div id="myDropdown" class="dropdown-content">
                        <button id="#0000ff" onclick="SetKeycaps(this.id, 'Switch Bleu')" class="dropdown-button">
                            Switch Bleu (total: 91$)</button>
                        <button id="#ff0000" onclick="SetKeycaps(this.id, 'Switch Rouge')" class="dropdown-button">
                            Switch Rouge (total: 31$) </button>
                        <button id="#582900" onclick="SetKeycaps(this.id, 'Switch Marron')" class="dropdown-button">
                            Switch Marron (total: 122$) </button>
                    </div>
                </div>
            </div>
            ...
            <div class="backplate-line">
                <div class="gauche">
                    ...
                    <div class="backplate">
                        <button id="#bbbbbb"
                            class="backplate-btn <?php if (isset($_POST["backplate-color"]) && $_POST["backplate-color"] == "#bbbbbb") {
                                echo "clicked-btn";
                            } ?>"
                            onclick="SetBackplate(this.id)">
                    ...
                    <div class="backplate">
                        <button id="#000000"
                            class="backplate-btn <?php if (isset($_POST["backplate-color"]) && $_POST["backplate-color"] == "#000000") {
                                echo "clicked-btn";
                            } ?>"
                            onclick="SetBackplate(this.id)">
                    ...
                    <div class="backplate">
                        <button id="#ffffff"
                            class="backplate-btn <?php if (isset($_POST["backplate-color"]) && $_POST["backplate-color"] == "#ffffff") {
                                echo "clicked-btn";
                            } ?>"
                            onclick="SetBackplate(this.id)">
                    ...
                    <div class="backplate">
                        <button id="#cd853f"
                            class="backplate-btn <?php if (isset($_POST["backplate-color"]) && $_POST["backplate-color"] == "#cd853f") {
                                echo "clicked-btn";
                            } ?>"
                            onclick="SetBackplate(this.id)">
    ...
    <div class="custom-bot">
        ...
        <div class="info">';
            ...
            <form action="" id="form-action" method="POST">
                <input type="hidden" id="backplate-color" name="backplate-color"
                    value="<?php if (isset($_POST["backplate-color"])) {
                        echo $_POST["backplate-color"];
                    } else {
                        echo "undefine";
                    } ?>">
                <input type="hidden" id="keycaps-color" name="keycaps-color"
                    value="<?php if (isset($_POST["keycaps-color"])) {
                        echo $_POST["keycaps-color"];
                    } else {
                        echo "undefine";
                    } ?>">
